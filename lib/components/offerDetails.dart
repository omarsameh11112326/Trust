...
class _OfferDetailsState extends State<OfferDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<QuerySnapshot>(
      future: products.where('nameOffer', isEqualTo: widget.nameProduct).get(),
      builder: (context, snapshot) {
        ...
        final String description = productData['descriptionOffer'] ?? 'No description available';
        final String price = productData['priceOffer'] ?? 'No price available';
